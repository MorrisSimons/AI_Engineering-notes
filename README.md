...
Here you'll find a collection of valuable resources and notes that I've gathered. Additional useful documentation and links are available in the files above.

## Recommended Links

- [OpenAI Cookbook](https://cookbook.openai.com/)
- [LlamaIndex: Use Cases for Agents](https://docs.llamaindex.ai/en/stable/use_cases/agents/)
- [LLM Agents Research - Prompting Guide](https://www.promptingguide.ai/research/llm-agents)
- [LangChain Agents Documentation](https://python.langchain.com/v0.1/docs/modules/agents/)
